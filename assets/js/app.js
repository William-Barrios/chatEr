import socket from "./user_socket.js"//Con esto establecemos una conexion del lado del 
//cliente, mediante un canal del framework phoenix
//DESDE AQUI
// Include phoenix_html to handle method=PUT/DELETE in forms and buttons.
import "phoenix_html"//Con esto se podra manejar los metodos PUT y DELETE en 
//formularios y botones
import {Socket} from "phoenix"
import {LiveSocket} from "phoenix_live_view"//estas ultimas dos son importaciones 
//para conectar con el framework pheonix y manejar las actualizaciones en tiempo real
import topbar from "../vendor/topbar"//importacion para barra de carga (no muy util pero viene por defecto)
//Estas dos obtendran el token del HTML para seguridad de aplicacion
...
//HASTA AQUI
//Es el codigo brindado por Elixir Phoenix LiveView, en el que se establece la construccion
// de interfaces en tiempo real
